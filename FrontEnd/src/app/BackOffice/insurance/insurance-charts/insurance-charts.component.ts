...
export class InsuranceChartsComponent implements OnInit, AfterViewInit {
  ...
  loadCategoryData(): void {
    this.http.get('http://localhost:8081/Insurance/category-count').subscribe((data: any) => {
  ...
  loadMonthlyData(): void {
    this.http.get('http://localhost:8081/Insurance/monthly-count').subscribe((data: any) => {
